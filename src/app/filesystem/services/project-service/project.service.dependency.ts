...
export const projectServiceDep: DependencyConfigurer<ProjectService> = new DependencyConfigurer<ProjectService>({
  ...
  dependencies: [Store, fileServiceDep.getToken(), numberIdGeneratorServiceDep.getToken()],
  factory: (store: Store<Projects>, fileService: FileService, idGeneratorService: IdGeneratorService) => {
